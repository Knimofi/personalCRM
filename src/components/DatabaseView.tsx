...
export const DatabaseView = () => {
  ...
  return <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
          <div className="flex-1 min-w-0">
            {nextBirthdayContact && <div className="text-xs text-gray-500 mb-1 leading-tight" style={{
            fontSize: '10px'
          }}>
                next birthday: {nextBirthdayContact.name} ({formatBirthdayDate(nextBirthdayContact.birthday!)})
              </div>}
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 leading-tight text-left">
              Contact Database
            </h2>
          </div>
